...
const EXACT_TEXT_EN: Record<string, string> = {
  ...
  "Connexion espace revendeur": "Reseller space login",
  "Identifiant revendeur": "Reseller ID",
  "Identifiant revendeur ou code PIN incorrect.": "Invalid reseller ID or PIN.",
  "Espace revendeur": "Reseller space",
  "Commande de consommables": "Consumables ordering",
  "Passez vos commandes et suivez vos demandes de consommables OberA.":
    "Place your orders and track your OberA consumables requests.",
  "Nouvelle commande": "New order",
  "Suivi des commandes": "Order tracking",
  "Catalogue consommables": "Consumables catalog",
  "Tarifs revendeur": "Reseller pricing",
  "Historique commandes": "Order history",
  "Support revendeur": "Reseller support",
  "Edition autorisee": "Editing allowed",
  "Lecture seule": "Read-only",
  "Espace": "Space"
  ,
  "Campagnes": "Campaigns",
  "Planification et calendrier campagnes.": "Campaign planning and calendar.",
  "Contenus & branding": "Content & branding",
  "Bibliotheque et guidelines visuelles.": "Library and visual guidelines.",
  "Site & SEO": "Website & SEO",
  "Pages, articles et optimisation.": "Pages, articles and optimization.",
  "Social & Ads": "Social & Ads",
  "Publications, campagnes paid.": "Posts and paid campaigns.",
  "Events": "Events",
  "Salons et activations.": "Trade shows and activations.",
  "Reporting": "Reporting",
  "Performances et KPIs.": "Performance and KPIs.",
  "Leads & CRM": "Leads & CRM",
  "Suivi prospects et pipeline.": "Lead tracking and pipeline.",
  "Devis / Offres": "Quotes / Offers",
  "Creation et validation.": "Creation and validation.",
  "Opportunites": "Opportunities",
  "Suivi des deals.": "Deal tracking.",
  "Relances": "Follow-ups",
  "Suivi client et relances.": "Client follow-up and reminders.",
  "Chiffres et previsions.": "Figures and forecasts.",
  "Commandes": "Orders",
  "Pilotage commandes et statuts.": "Order tracking and status.",
  "Facturation": "Invoicing",
  "Emission et suivi.": "Issuing and tracking.",
  "Avoirs & litiges": "Credit notes & disputes",
  "Gestion des incidents.": "Incident management.",
  "Documents client": "Client documents",
  "Archivage et partage.": "Archiving and sharing.",
  "Stocks": "Stock",
  "Niveaux et alertes.": "Levels and alerts.",
  "Expeditions": "Shipments",
  "Preparation et suivi.": "Preparation and tracking.",
  "Receptions": "Receipts",
  "Controle et entree stock.": "Control and stock entry.",
  "Inventaires": "Inventories",
  "Campagnes et audits.": "Campaigns and audits.",
  "Filtres, cartouches, accessoires et references.":
    "Filters, cartridges, accessories and references.",
  "Conditions et remises appliquees.": "Terms and applied discounts.",
  "Historique et tracking.": "History and tracking.",
